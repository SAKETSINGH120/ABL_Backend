...
exports.getHomeData = catchAsync(async (req, res, next) => {
  ...
  const [today, last7Days, last30Days] = await Promise.all([getEarnings(startOfToday, endOfToday), getEarnings(startOf7Days, new Date()), getEarnings(startOf30Days, new Date())]);
