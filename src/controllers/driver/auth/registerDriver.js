...
exports.registerDriver = catchAsync(async (req, res, next) => { 
    const {
        ...
        vehicleType, vehicleModel, registrationNumber, insuranceNumber, deviceId, deviceToken, serviceType,ifsc,bankName,branchName,accountNo,benificiaryName,passbook,personWithDisability
    } = req.body;
